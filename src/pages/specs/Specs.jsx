  ...
  return (
    <div className="h-full w-full flex max-sm:justify-center p-2 overflow-hidden relative">
      <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-r from-zinc-900 to-zinc-700 after:absolute after:h-full after:w-full after:top-0 after:left-0 after:bg-black/30">
        {/* <span className="absolute z-[3] -bottom-1/4 -left-20 bg-orange-500 blur-main blur-css back opacity-70 w-96 h-96 rounded-full flex" /> */}
        <img
          className="absolute z-[4] bottom-0 scale-110 max-xl:scale-[1.5] max-sm:scale-[2.5] translate-x-[10%] max-xl:-translate-x-[2%] max-sm:-translate-x-[20%] -translate-y-[5%] max-xl:-translate-y-[10%] max-sm:-translate-y-[70%]"
      ...
      <div className="absolute h-full sm:max-w-[420px] z-10 left-0 top-0 p-2 md:p-4 pt-[100px] md:pt-[100px] overflow-y-auto scrollBarr-off">
        <ul className="flex flex-col gap-2 max-sm:m-2">
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Size</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
          ...
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Color</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
              <li>Black, Khaki, Sand</li>
            </ul>
          </li>
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Motor</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
          ...
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Battery</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
              <li>Brand: Custom design by Cowboy</li>
              <li>Weight: 2.4kg</li>
          ...
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Charger</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
              <li>Voltage: 36V</li>
            </ul>
          </li>
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Speed</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
              <li>Up to 25km/h (20 mph in the USA)</li>
            </ul>
          </li>
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Transmission</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
              <li>Type: Gates carbon belt transmission</li>
            </ul>
          </li>
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Gear ratio</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
          ...
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Lights</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
              <li>
          ...
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Grips</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
              <li>Custom-designed Cowboy Grips</li>
            </ul>
          </li>
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Tires</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
              <li>
          ...
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Inner Tubes</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
              <li>
          ...
          <li className="p-4 pl-6 w-fit border-[1px] border-orange-900 rounded-lg bg-zinc-950/20 backdrop-blur-[3px]">
            <h3 className="font-semibold text-slate-300">Brakes</h3>
            <ul className="font-light list-[circle] text-xs lg:text-sm text-slate-300 flex flex-col">
